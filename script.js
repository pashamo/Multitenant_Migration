function stringParser() {
    ...
    for (i = 0; i < splitPhase1.length; i = i+2) {
        if (splitPhase1[i+1] == "TEMPAPPDEVELOPER") {
            document.getElementById("createCMD").innerHTML = document.getElementById("createCMD").innerHTML + "CREATE user " + splitPhase1[i] + " profile ENDUSER" + /*DEVELOPER*/ " identified by \"" + password + "\" default tablespace endusers temporary tablespace temporary quota unlimited on endusers account unlock;<br><br>";
        }
        else {
        ...
        if (splitPhase1[i+1] == "DEVELOPER") {// || splitPhase1[i+1] == "TEMPAPPDEVELOPER") {
